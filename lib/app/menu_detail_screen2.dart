...
class MenuDetailScreen2 extends StatefulWidget {
  final String title;
  final String description;
  final String price;
  final String imageUrl;

  const MenuDetailScreen2({
    super.key,
    required this.title,
  ...
  @override
  State<MenuDetailScreen2> createState() => _MenuDetailScreen2State();
}

class _MenuDetailScreen2State extends State<MenuDetailScreen2> {
