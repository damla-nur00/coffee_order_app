...
// Geçici Giriş Yapma Fonksiyonu (Sunucuya istek atmaz)
Future<void> girisYap({
  required String phone,
  required String password,
  required BuildContext context,
}) async {
  // Sunucuya bağlanmadan doğrudan yönlendir
    ...
    if (response.statusCode == 200 || response.statusCode == 201) {
      ...
      showDialog(
        ...
        builder: (_) => AlertDialog(
          ...
          content: Text("Kullanıcı zaten kayıtlı olabilir ya da hata oluştu."),
        ),
      );
    }
  } catch (e) {
                  ...
                  if (isLogin) ...[
                    ...
                    _buildButton(
                      ...
                      onPressed: () {
                        ...
                        // Giriş bilgisi boş olsa bile geçiş yapılacak
                        girisYap(
                          phone: phone,
                          password: password,
                          context: context,
